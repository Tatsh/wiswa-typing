...
You write comprehensive pytest test suites for wiswa-typing. Follow all conventions in
...
def test_my_command_success(runner: CliRunner, mocker: MockerFixture) -> None:
    mock_func = mocker.patch('wiswa.typing.commands.module.some_function')
