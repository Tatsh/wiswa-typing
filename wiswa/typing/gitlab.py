"""Type definitions for GitLab REST payloads and badge shapes used by the Wiswa ecosystem."""
from __future__ import annotations

from typing import Literal, TypeAlias, TypedDict

__all__ = ('AccessLevelEntry', 'AccessLevelLiteral', 'Badge', 'BranchProtectionOverrides',
           'ProjectApprovals', 'ProjectSettings', 'PushRules', 'RemoteSettings')

AccessLevelLiteral: TypeAlias = Literal['disabled', 'private', 'enabled']
...
class ProjectSettings(TypedDict, total=False):
    ...
    analytics_access_level: AccessLevelLiteral
    ...
    merge_requests_access_level: AccessLevelLiteral
    """Visibility of merge requests."""
    monitor_access_level: AccessLevelLiteral
    ...
    pages_access_level: AccessLevelLiteral
    """Visibility of GitLab Pages."""
    releases_access_level: AccessLevelLiteral
    ...
    repository_access_level: AccessLevelLiteral
    ...
    requirements_access_level: AccessLevelLiteral
    ...
    wiki_access_level: AccessLevelLiteral
